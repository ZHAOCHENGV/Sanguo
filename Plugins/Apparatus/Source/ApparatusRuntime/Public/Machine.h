		...
		ReleaseSubjectInfo(const int32 SubjectPlace)
		{
			...
			}
			{
				...
				if (Info->Subjective)
				{
					...
					// Reset the subject-level...
					Info->Subjective = nullptr;
					SubjectiveSave->Handle.ResetHandle();
					// Unregister the subjective level:
					SubjectiveSave->Unregister();
...
#pragma endregion Mechanisms
	 ...
	 */
	OPTIONAL_FORCEINLINE static UMachine*
	RetainInstance()
	{
...
#pragma region Trait Registry
	...
	OPTIONAL_FORCEINLINE FTraitInfo&
...
#pragma region Mechanism Registry
	 ...
	 */
	OPTIONAL_FORCEINLINE const FSubjectPool&
	 ...
	 * @return The subject pool for the mechanism.
	 */
	OPTIONAL_FORCEINLINE FSubjectPool&
...
#pragma region Subjects
	 ...
	 */
	static OPTIONAL_FORCEINLINE FSubjectInfo&
	 ...
	 */
	template < EParadigm Paradigm = EParadigm::DefaultInternal >
	OPTIONAL_FORCEINLINE TOutcome<Paradigm, FSubjectInfo*>
...
#pragma region Singleton
	 ...
	 */
	static OPTIONAL_FORCEINLINE UMachine*
	ObtainInstance()
	{
		if (LIKELY(Instance))
		{
...
#pragma endregion Singleton
	 ...
	 */
	static OPTIONAL_FORCEINLINE AMechanism*
