 ...
 * Hash the class.
 */
OPTIONAL_FORCEINLINE uint32 GetTypeHash(const UClass* InClass)
{
 ...
 */
OPTIONAL_FORCEINLINE uint32 GetTypeHash(const EBootFilter& BootFilter)
{
 ...
 */
OPTIONAL_FORCEINLINE EBootFilter BootFilterFromState(const bool bState)
{
 ...
 */
OPTIONAL_FORCEINLINE FString BootFilterToString(const EBootFilter BootFilter)
{
 ...
 */
OPTIONAL_FORCEINLINE EBootState
