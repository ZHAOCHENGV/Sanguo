 ...
 * ░▒▓ APPARATUS ▓▒░
 * 
 * File: SubjectHandles8.h
 * Created: 2021-06-23 22:46:04
...
#include "SubjectHandles8.generated.h"
...
struct APPARATUSRUNTIME_API FSubjectHandles8
{
	GENERATED_BODY()
  ...
  private:
	 ...
	 */
	TArray<FSubjectHandle, TInlineAllocator<8>> Handles;
  ...
  public:
	 ...
	 */
	OPTIONAL_FORCEINLINE const FSubjectHandle&
