...
#pragma region Identification
	 ...
	 * @see GetId()
	 */
	OPTIONAL_FORCEINLINE GenerationType
	GetGeneration() const
	{
		return Generation;
	}
...
#pragma region Common Functionality
	 ...
	 */
	OPTIONAL_FORCEINLINE FCommonSubjectHandle&
...
#pragma region Components Examination
	 ...
	 */
	template < typename T >
	OPTIONAL_FORCEINLINE typename std::enable_if<IsTraitType<T>(), bool>::type
	HasTrait() const
	{
  ...
  : public FCommonSubjectHandle
{
  ...
  public:
	 ...
	 * Clear the subject handle, essentially making it invalid.
	 */
	OPTIONAL_FORCEINLINE TSubjectHandle&
	operator=(TYPE_OF_NULLPTR)
	{
		ResetHandle();
		return *this;
...
#pragma region Context
	 ...
	 */
	template < EParadigm Paradigm = EParadigm::Default >
	OPTIONAL_FORCEINLINE TOutcomeIfUnsafeOr<Paradigm, AllowsStructuralChanges>
...
#pragma region Despawning
	...
	Despawn() const
	{
		...
		// Make it as invalid early:
		const_cast<TSubjectHandle*>(this)->Id = InvalidId;
...
#pragma region Flagmark
	 ...
	 */
	template < EParadigm Paradigm = EParadigm::Default >
	OPTIONAL_FORCEINLINE TOutcomeIfUnsafeOr<Paradigm, AllowsChanges, EFlagmark>
	...
	OPTIONAL_FORCEINLINE typename std::enable_if<AllowsChanges || IsUnsafe(Paradigm), EApparatusStatus>::type
	...
	template < EParadigm Paradigm = EParadigm::Default >
	[[deprecated("The method is deprecated. Use the 'SetFlagmark' method within a polite paradigm, please.")]]
	OPTIONAL_FORCEINLINE typename std::enable_if<AllowsChanges || (Paradigm <= EParadigm::Unsafe), EApparatusStatus>::type
	 ...
	 */
	template < EParadigm Paradigm = EParadigm::Default >
	OPTIONAL_FORCEINLINE TOutcomeIfUnsafeOr<Paradigm, AllowsChanges, bool>
...
#pragma region Traits Data Access
	...
	{
		const auto Info = FindInfo();
		checkf(Info != nullptr, TEXT("The subject information must be present in order get a reference to a %s trait."),
...
#pragma region Traits Setting
	...
	template < EParadigm Paradigm = EParadigm::Default,
			   typename T = void,
			   typename std::enable_if<(AllowsStructuralChanges || IsUnsafe(Paradigm)) && IsTraitType<T>(), bool>::type = true >
	OPTIONAL_FORCEINLINE TOutcome<Paradigm>
	 ...
	 */
	template< EParadigm Paradigm = EParadigm::Default >
	OPTIONAL_FORCEINLINE TOutcomeIfUnsafeOr<Paradigm, AllowsChanges>
...
#pragma region Details Getting
	 ...
	 * @return nullptr If there is no such detail.
	 */
	OPTIONAL_FORCEINLINE TDetailPtrResult<UDetail>
	 ...
	 */
	template < class D >
	OPTIONAL_FORCEINLINE TDetailPtrResult<D>
	GetDetail() const
	{
