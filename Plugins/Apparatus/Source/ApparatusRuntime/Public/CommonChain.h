...
#include "HAL/Event.h"
#include "Async/AsyncWork.h" // For non-abandoned Common task.
...
struct FCommonChain
{
  ...
  protected:
	...
	struct TSegment
	{
		 ...
		 */
		OPTIONAL_FORCEINLINE TScriptInterface<IIterable>
		GetIterable() const
		{
...
#pragma region Common Cursor Examination
		 ...
		 */
		OPTIONAL_FORCEINLINE const FCommonChain*
		GetOwner() const
		{
			return Owner;
		}
...
#pragma endregion Common Cursor Examination
	 ...
	 * @return The status of the operation.
	 */
	virtual OPTIONAL_FORCEINLINE EApparatusStatus
