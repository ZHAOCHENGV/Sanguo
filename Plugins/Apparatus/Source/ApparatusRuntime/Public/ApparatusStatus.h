 ...
 */
template < typename T >
constexpr OPTIONAL_FORCEINLINE bool
IsStatusType()
{
 ...
 */
constexpr OPTIONAL_FORCEINLINE EApparatusStatus
  ...
  : public FCommonHarshOutcome
{
	 ...
	 */
	constexpr OPTIONAL_FORCEINLINE PayloadT
	GetPayload() const
	{
		return Payload;
	}
	 ...
	 */
	template < typename T >
	OPTIONAL_FORCEINLINE THarshOutcome<T>
	StaticCast()
	{
	 ...
	 * Dereference.
	 */
	OPTIONAL_FORCEINLINE THarshOutcome<PayloadT&>
	Dereference()
	{
	 ...
	 */
	constexpr OPTIONAL_FORCEINLINE
...
#pragma region A Pointer-Like Interface
	 ...
	 */
	constexpr OPTIONAL_FORCEINLINE const PayloadT&
	operator*() const
	{
		return Payload;
	}
...
#pragma endregion Direct Payload Comparison
	...
	OPTIONAL_FORCEINLINE THarshOutcome&
  ...
  : public FCommonHarshOutcome
{
	 ...
	 * Get the payload of the outcome.
	 */
	OPTIONAL_FORCEINLINE PayloadType
	GetPayload() const
	{
		return Payload;
	}
  ...
  : public FCommonHarshOutcome
{
	 ...
	 */
	constexpr OPTIONAL_FORCEINLINE void
	GetPayload() const
	{}
...
#pragma region Pointer-Like Interface
	 ...
	 */
	template < typename T >
	OPTIONAL_FORCEINLINE TPoliteOutcome<T>
	StaticCast()
	{
	 ...
	 * Dereference.
	 */
	OPTIONAL_FORCEINLINE TPoliteOutcome<PayloadT&>
	Dereference()
	{
...
#pragma endregion Direct Payload Comparison
	 ...
	 */
	template < typename InPayloadT >
	OPTIONAL_FORCEINLINE TPoliteOutcome&
	...
	constexpr OPTIONAL_FORCEINLINE TPoliteOutcome
	operator+(const EApparatusStatus InStatus) const
	{
...
struct TOutcomeMaker
{
	...
	static constexpr OPTIONAL_FORCEINLINE auto
...
struct TOutcomeMaker<Paradigm, PayloadT, /*bHarsh=*/true>
{
	...
	{
		template < typename InPayloadT >
		static OPTIONAL_FORCEINLINE PayloadT
		Do(InPayloadT&& Payload)
		{
			check(OK(Status));
	...
	{
		template < typename InPayloadT >
		static constexpr OPTIONAL_FORCEINLINE PayloadT
		Do(InPayloadT&& Payload)
		{
			return std::forward<InPayloadT>(Payload);
		}
...
struct TOutcomeMaker<Paradigm, /*PayloadT=*/void, /*bHarsh=*/true>
{
	...
	struct TStatusResolver
	{
		static OPTIONAL_FORCEINLINE auto
		Do()
		{
			check(OK(Status));
			return THarshOutcome<>();
	...
	template < EApparatusStatus Status >
	static constexpr OPTIONAL_FORCEINLINE TOutcome<Paradigm>
	Do()
	{
...
{
	template < EApparatusStatus Status >
	static constexpr OPTIONAL_FORCEINLINE EApparatusStatus
	Do()
	{
		return Status;
	}
...
constexpr OPTIONAL_FORCEINLINE TOutcome<Paradigm, void>
...
constexpr OPTIONAL_FORCEINLINE TOutcome<Paradigm, PayloadT>
...
template < EParadigm Paradigm, typename L >
constexpr OPTIONAL_FORCEINLINE TOutcome<Paradigm>
...
template < EParadigm Paradigm, typename L >
constexpr OPTIONAL_FORCEINLINE auto
...
constexpr OPTIONAL_FORCEINLINE THarshOutcome<To>
 ...
 */
template < typename To, typename PayloadT >
constexpr OPTIONAL_FORCEINLINE TPoliteOutcome<To>
...
constexpr OPTIONAL_FORCEINLINE TPoliteOutcome<void>
 ...
 */
template < typename APayloadT >
constexpr OPTIONAL_FORCEINLINE TPoliteOutcome<APayloadT>
...
constexpr OPTIONAL_FORCEINLINE typename TOutcomeCombiner<
 ...
 */
template < size_t N >
constexpr OPTIONAL_FORCEINLINE THarshOutcome<void>
 ...
 */
template < typename PayloadT, size_t N >
constexpr OPTIONAL_FORCEINLINE THarshOutcome<PayloadT>
OutcomeCombine(const THarshOutcome<PayloadT> (&Outcomes)[N],
 ...
 * @return The resulting harsh outcome.
 */
OPTIONAL_FORCEINLINE THarshOutcome<void>
 ...
 * @return The resulting harsh outcome.
 */
OPTIONAL_FORCEINLINE TPoliteOutcome<void>
...
class APPARATUSRUNTIME_API FApparatusStatus
{
  public:
	 ...
	 */
	static OPTIONAL_FORCEINLINE EApparatusStatus
	GetLastError()
	{
...
class APPARATUSRUNTIME_API FApparatusDelegates
{
  public:
	 ...
	 */
	static OPTIONAL_FORCEINLINE void
  ...
  private:
	...
	struct FInitializer
	{
		OPTIONAL_FORCEINLINE FInitializer()
		{
