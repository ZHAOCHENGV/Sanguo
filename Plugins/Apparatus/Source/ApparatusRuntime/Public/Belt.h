  ...
  , public IIterable
{
  ...
  public:
	 ...
	 * @return The belt slot.
	 */
	OPTIONAL_FORCEINLINE FBeltSlot&
						...
						const int32          DetailIndex) const
{
	...
	if (LIKELY(Details[DetailIndex].IterableNum() == 1))
	{
		...
		RetDetail = Details[DetailIndex][0];
	}
	else
	{
		...
		RetDetail = Details[DetailIndex][SubIndex];
	}
...
OPTIONAL_FORCEINLINE struct FBeltSlot*
...
OPTIONAL_FORCEINLINE const struct FBeltSlot*
