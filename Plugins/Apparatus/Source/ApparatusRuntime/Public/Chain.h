...
#include "Async/AsyncWork.h" // Asynchronous execution.
  ...
  public:
	  ...
	  : public FCommonCursor
	{
	  ...
	  public:
		 ...
		 */
		OPTIONAL_FORCEINLINE const TChain*
		GetOwner() const
		{
		 ...
		 */
		OPTIONAL_FORCEINLINE SubjectHandleType
		GetSubject() const
		{
		 ...
		 */
		OPTIONAL_FORCEINLINE SubjectivePtrType
		GetSubjective() const
		{
		...
		OPTIONAL_FORCEINLINE TOutcome<Paradigm, TTraitVoidPtrResult<Paradigm>>
		...
		template < EParadigm Paradigm, typename T,
				   more::enable_if_t<IsUnsafe(Paradigm) || AllowsDirectTraitAccess, int> = 0 >
		OPTIONAL_FORCEINLINE TOutcome<Paradigm, TTraitPtrResult<Paradigm, T>>
		GetTraitPtr() const
		{
		...
		template < EParadigm Paradigm, typename T,
				   more::enable_if_t<IsUnsafe(Paradigm) || AllowsDirectTraitAccess, int> = 0 >
		OPTIONAL_FORCEINLINE TOutcome<Paradigm, TTraitRefResult<Paradigm, T>>
		GetTraitRef() const
		{
...
#pragma region Cursor Details
		 ...
		 */
		template < EParadigm Paradigm = DefaultParadigm >
		OPTIONAL_FORCEINLINE TOutcome<Paradigm, UDetail*>
		...
		OPTIONAL_FORCEINLINE TOutcome<Paradigm, TDetailPtrResult<D>>
		...
		OPTIONAL_FORCEINLINE TOutcome<Paradigm, TDetailPtrResult<UDetail>>
...
#pragma region Flagmark Getting
		...
		{
			static OPTIONAL_FORCEINLINE FlagmarkT
...
#pragma region Trait Getting
		  ...
		  : public TCommonPartGetter<TraitT, PT_Trait, PDT_Value>
		{
			...
			static OPTIONAL_FORCEINLINE TraitT
			Get(const TCursor& InCursor)
			{
...
#pragma region Detail Getting
		  ...
		  : public TCommonPartGetter<DetailT, PT_Detail, PDT_Reference>
		{
			...
			static OPTIONAL_FORCEINLINE DetailT
			Get(const TCursor& InCursor)
			{
...
#pragma region Cursor Getting
		  ...
		  : public TCommonPartGetter<const TCursor&, PT_Cursor, PDT_Reference>
		{
			...
			static OPTIONAL_FORCEINLINE const TCursor&
			Get(const TCursor& InCursor)
			{
				return InCursor;
			}
		  ...
		  : public TCommonPartGetter<const TCursor<OtherPs...>, PT_Cursor, PDT_Value>
		{
			...
			static OPTIONAL_FORCEINLINE TCursor<OtherPs...>
			Get(const TCursor& InCursor)
			{
				return InCursor;
			}
		  ...
		  : public TCommonPartGetter<const CursorSuper&, PT_Cursor, PDT_Reference>
		{
			...
			static OPTIONAL_FORCEINLINE const CursorSuper&
			Get(const TCursor& InCursor)
			{
				return InCursor;
			}
...
#pragma region Subject Getting
		  ...
		  : public TCommonPartGetter<PartSubjectHandleT>
		{
			...
			static OPTIONAL_FORCEINLINE PartSubjectHandleT
			Get(const TCursor& InCursor)
			{
		  ...
		  : public TCommonPartGetter<const PartSubjectHandleT>
		{
			...
			static OPTIONAL_FORCEINLINE const PartSubjectHandleT
			Get(const TCursor& InCursor)
			{
				return ::template SmartCast<PartSubjectHandleT, DefaultParadigm>(InCursor.GetSubject());
			}
...
#pragma region Subjective Getting
		  ...
		  : public TCommonPartGetter<SubjectiveC>
		{
			...
			static OPTIONAL_FORCEINLINE SubjectiveC
			Get(const TCursor& InCursor)
			{
...
#pragma region Solid Subjective Getting
		  ...
		  : public TCommonPartGetter<ISolidSubjective&>
		{
			...
			static OPTIONAL_FORCEINLINE ISolidSubjective&
			Get(const TCursor& InCursor)
			{
...
#pragma region Chain Getting
		  ...
		  : public TCommonPartGetter<const TChain*>
		{
			...
			static OPTIONAL_FORCEINLINE const TChain*
			Get(const TCursor& InCursor)
			{
...
#pragma region Mechanism Getting
		  ...
		  : public TCommonPartGetter<const AMechanism*, PT_Other, PDT_Pointer>
		{
			...
			static OPTIONAL_FORCEINLINE const AMechanism*
			Get(const TCursor& InCursor)
			{
...
#pragma endregion Initialization
  ...
  public:
	 ...
	 */
	template < typename... Ps >
	OPTIONAL_FORCEINLINE TCursor<Ps...>
...
#pragma region Traits Data Access
	 ...
	 */
	template < EParadigm Paradigm = DefaultParadigm >
	OPTIONAL_FORCEINLINE TTraitVoidPtrResult<Paradigm>
	GetTraitPtr(UScriptStruct* const TraitType) const
	{
