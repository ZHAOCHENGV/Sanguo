...
#pragma region Slots
	 ...
	 * Get a slot at a certain position.
	 */
	OPTIONAL_FORCEINLINE std::conditional_t<AllowsChanges, FChunkSlot&, const FChunkSlot&>
...
#pragma region Traits Data Access
	 ...
	 */
	template < EParadigm Paradigm, typename T >
	OPTIONAL_FORCEINLINE TTraitRefResult<Paradigm, const T>
	 ...
	 */
	template < EParadigm Paradigm, typename T >
	OPTIONAL_FORCEINLINE TTraitRefResult<Paradigm, T>
	 ...
	 */
	template < EParadigm Paradigm, typename T >
	OPTIONAL_FORCEINLINE TTraitPtrResult<Paradigm, const T>
	 ...
	 */
	template < EParadigm Paradigm, typename T >
	OPTIONAL_FORCEINLINE TTraitPtrResult<Paradigm, T>
