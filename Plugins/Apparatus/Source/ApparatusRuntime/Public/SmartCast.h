...
struct TSmartCastImpl
{
	...
	static OPTIONAL_FORCEINLINE ToType
...
struct TSmartCastImpl<AnyParadigm, /*From=*/Same, /*To=*/Same, DeferredCheck>
{
	...
	static OPTIONAL_FORCEINLINE Same
...
struct TSmartCastImpl<Paradigm, /*From=*/ISubjective*, /*To=*/const ISubjective, DeferredCheck>
{
	...
	static OPTIONAL_FORCEINLINE const ISubjective*
...
OPTIONAL_FORCEINLINE typename TSmartCastImpl<Paradigm, From, To>::ToType
 ...
 */
OPTIONAL_FORCEINLINE FSolidSubjectHandle::SubjectivePtrType
