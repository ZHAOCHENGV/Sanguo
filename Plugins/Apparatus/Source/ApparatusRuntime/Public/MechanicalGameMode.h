...
OPTIONAL_FORCEINLINE AMechanicalGameMode::AMechanicalGameMode()
{
...
OPTIONAL_FORCEINLINE void AMechanicalGameMode::BeginPlay()
{
	Super::BeginPlay();
	DoRegister();
}

OPTIONAL_FORCEINLINE void AMechanicalGameMode::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
	DoUnregister();
	Super::EndPlay(EndPlayReason);
}

OPTIONAL_FORCEINLINE void AMechanicalGameMode::Tick(float DeltaTime)
{
