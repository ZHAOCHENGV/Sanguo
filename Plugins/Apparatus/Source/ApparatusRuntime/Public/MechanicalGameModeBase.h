...
OPTIONAL_FORCEINLINE AMechanicalGameModeBase::AMechanicalGameModeBase()
{
...
OPTIONAL_FORCEINLINE void AMechanicalGameModeBase::BeginPlay()
{
	Super::BeginPlay();
	DoRegister();
}

OPTIONAL_FORCEINLINE void AMechanicalGameModeBase::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
	DoUnregister();
	Super::EndPlay(EndPlayReason);
}

OPTIONAL_FORCEINLINE void AMechanicalGameModeBase::Tick(float DeltaTime)
{
