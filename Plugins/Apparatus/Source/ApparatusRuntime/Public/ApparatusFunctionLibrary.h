...
#pragma endregion Subject Handles Arrays
	...
	MakeFingerprint(const TArray<UScriptStruct*>&       Traits,
					...
					UPARAM(Meta=(Bitmask, BitmaskEnum="/Script/ApparatusRuntime.EFlagmark")) const int32 Flagmark);
...
#pragma endregion Trait Record
	...
	UFUNCTION(BlueprintCallable, BlueprintPure,
			  ...
			  Category = "Apparatus|Fingerprint")
	static UPARAM(Meta=(Bitmask, BitmaskEnum="/Script/ApparatusRuntime.EFlagmark")) int32
	...
	MakeFilter(const TArray<UScriptStruct*>&       Traits,
			   ...
			   UPARAM(Meta=(Bitmask, BitmaskEnum="/Script/ApparatusRuntime.EFlagmark")) const int32 Flagmark = 0x2/*FM_Booted*/,
			   UPARAM(Meta=(Bitmask, BitmaskEnum="/Script/ApparatusRuntime.EFlagmark")) const int32 ExcludingFlagmark = 0x1/*FM_Stale*/);
...
#pragma region Chain
	 ...
	 * @param Mechanism The explicit mechanism instance to utilize during the operation.
	 * If not set, the mechanism from the world context object will be used.
	 * @return The hinted detail instance.
	 */
	UFUNCTION(BlueprintCallable, BlueprintPure,
			  BlueprintInternalUseOnly,
			  Category = "Apparatus|Chain",
...
#pragma region Subject Records
	...
	DumpSubjectToRecord(UPARAM(Ref, Meta=(DisplayName = "Subject"))       FSubjectHandle& SubjectHandle,
						...
						UPARAM(Meta=(Bitmask, BitmaskEnum = "/Script/ApparatusRuntime.EFlagmark")) int32           FlagmarkMask = 0x7FFFFFE0)
	{
...
#pragma region Subjectives
	 ...
	 */
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "Apparatus|Subjective")
	static USubjectiveActorComponent*
...
#pragma region Flagmark
	...
	SetSubjectFlagmark(UPARAM(Meta=(DisplayName = "Subject"))            const FSubjectHandle& SubjectHandle,
					   UPARAM(Meta=(Bitmask, BitmaskEnum = "/Script/ApparatusRuntime.EFlagmark")) const int32           Flagmark = 0x0)
	{
...
#pragma region Details
	...
	FindSubjectiveDetail(TScriptInterface<ISubjective> Subjective,
						 ...
						 const bool                    bIncludeDisabled = false)
	{
		return Subjective->GetDetail<EParadigm::DefaultBlueprint>(DetailClass, bIncludeDisabled);
	}
...
inline TArray<UDetail*> UApparatusFunctionLibrary::FindSubjectiveDetails(
...
inline FFingerprint& UApparatusFunctionLibrary::AddDetailToFingerprint(
